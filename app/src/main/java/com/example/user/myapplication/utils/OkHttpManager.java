...
public class OkHttpManager {
    ...
    //纯粹键值对post请求
    public  synchronized void post(List<Param> params, String url, HttpCallBack httpCallBack) {
        Log.d("url----->>", url);
    ...
    //键值对+文件 post请求
    public   synchronized void post(List<Param> params, List<File> files, String url, HttpCallBack httpCallBack) {
        Log.d("url----->>", url);
        this.httpCallBack = httpCallBack;
    ...
    //键值对+文件 post请求
    public  synchronized void postMoments(List<Param> params, List<Uri> images, String url, HttpCallBack httpCallBack) {
        Log.d("url----->>", url);
        this.httpCallBack = httpCallBack;
        MultipartBody.Builder builder = new MultipartBody.Builder();
        builder.setType(MultipartBody.FORM);
